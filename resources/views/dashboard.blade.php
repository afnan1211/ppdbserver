...
<head>
  ...
  <title>PPDB pondok pesantren tahfizhul qur'an iphi surakarta</title>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex">
      ...
      <div class="logo mr-auto">
        <h1 class="text-light"><a href="index.html"><span>PPDB online</span></a></h1>
    ...
    <div class="row">
        ...
        <div>
            ...
            <h2>Pondok pesantren tahfizhul qur'an iphi surakarta Tahun Pelajaran 2024/2025</h2>
    ...
    <div class="container">
        ...
        <div class="col-lg-6 d-flex flex-column justify-contents-center" data-aos="fade-left">
            ...
            <ul>
                ...
                <li><i class="icofont-check-circled"></i> Melakukan test secara offline</li>
            ...
            <p>
                Selain pendaftaran mode online atau daring, kami juga masih melayani pendaftaran offline/luring dengan datang langsung ke sekretariat pendaftaran (pondok pesantren tahfidzul qur'an iphi surakarta).
            </p>
            </div>
        </div>
        </div>
        ...
        <div class="row">
          <div class="col-lg-8 col-md-6">
            <div class="footer-info">
              <h3>pondok pesantren tahfidzul qur'an iphi surakarta</h3>
              <p>
               Alamat : Jl. Srinarendro No. 1 Baron Laweyan Kota Surakarta <br>
                <strong>HP :</strong> 0895-1818-2126<br>
